package com.faris.kingkits.depreciated;
...
public class Updater {
	...
	private static final String[] NO_UPDATE_TAG = { "-DEV", "-PRE", "-SNAPSHOT", "Special", "Potion" }; // If the version number contains one of these, don't update.
