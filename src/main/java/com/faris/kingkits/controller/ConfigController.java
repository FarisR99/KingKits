...
public class ConfigController implements Controller {
	...
	private void saveDefaultConfig() {
		...
		this.getConfig().addDefault("Multi-inventories.Enabled", BukkitUtilities.hasPlugin(this.getConfig().getString("Multi-inventories.Plugin", "Multiverse-Inventories")), "Set this to 'false' if this plugin should handle player inventory clearing when a player changes worlds. Keep as 'true' if this plugin should not handle player inventories when changing worlds.");
